...
| `extendSubscriptionBy` | `false`                                                            | The number of billing periods to add to the customer's existing subscription. When provided, the checkout will charge the customer plan price × extendSubscriptionBy in a single payment and extend their subscription accordingly. |
...
a payment request with the SDK.
