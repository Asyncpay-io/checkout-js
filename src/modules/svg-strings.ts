export const svg = `<svg width="80px" height="80px" display="block" shape-rendering="auto" style="margin:auto" preserveAspectRatio="xMidYMid" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
